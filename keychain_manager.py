...
class KeychainManager:
    ...
    def authenticate_touch_id(reason="VPN 연결을 위한 Touch ID 인증"):
        ...
        if not can_evaluate:
            print(f"[KeychainManager] 생체/비밀번호 인증을 사용할 수 없습니다: {error}")
        ...
        def reply_handler(success, error):
            ...
            if not success and error:
                print(f"[KeychainManager] 인증 실패: {error}")
    ...
    def get_password(service, username):
        ...
        try:
            ...
            print(f"[KeychainManager] 키체인 조회 에러 ({service}/{username}): {e}")
            return None
    ...
    def save_password(service, username, password):
        ...
        try:
            ...
            print(f"[KeychainManager] 키체인 저장 에러 ({service}/{username}): {e}")
            return False
    ...
    def delete_password(service, username):
        ...
        try:
            ...
            print(f"[KeychainManager] 키체인 삭제 에러 ({service}/{username}): {e}")
            return False
